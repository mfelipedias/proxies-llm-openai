import { addAccount, removeAccount, listAccounts, getAccountCredentials, KimiAccount } from './core/accounts.ts'
...
async function showMenu() {
  ...
  while (true) {
    ...
    clear()
    console.log('=== KimiProxy Account Manager ===\n')
...
async function addAccountManualFlow(browserType: BrowserType) {
  ...
  console.log('A browser window will open. Please login to Kimi manually.')
