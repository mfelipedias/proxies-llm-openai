import { KimiAccount, loadAccounts } from './accounts.ts'
...
export function getNextAccount(): KimiAccount | null {
  ...
  let best: KimiAccount | null = null
 ...
 */
export function getNextAvailableAccount(skip?: string | Iterable<string>): KimiAccount | null {
  const accounts = loadAccounts()
