import { DeepSeekAccount, loadAccounts } from './accounts.ts'
...
export function getNextAccount(): DeepSeekAccount | null {
  ...
  let best: DeepSeekAccount | null = null
...
export function getNextAvailableAccount(skipAccountId?: string): DeepSeekAccount | null {
  const accounts = loadAccounts()
