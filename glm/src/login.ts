import { addAccount, removeAccount, listAccounts, getAccountCredentials, GLMAccount } from './core/accounts.ts'
...
async function showMenu() {
  ...
  while (true) {
    ...
    clear()
    console.log('=== GLMProxy Account Manager ===\n')
...
async function addAccountManualFlow(browserType: BrowserType) {
  ...
  console.log('A browser window will open. Please login to GLM (z.ai) manually.')
