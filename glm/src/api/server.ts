...
// Middlewares ANTES das rotas: no Hono, um app.use só se aplica a rotas
// registradas depois dele — registrar rotas primeiro desativa o middleware
// (a proteção por API_KEY ficava inoperante).
